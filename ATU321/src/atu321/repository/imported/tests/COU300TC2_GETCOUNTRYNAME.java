...
public class COU300TC2_GETCOUNTRYNAME {

	static String inputXMLFilePath = "testcases/atu321.repository.imported.tests/COU300TC2_GETCOUNTRYNAME.xml";
	String input;
	String expectedResult;

	public COU300TC2_GETCOUNTRYNAME(String input, String expectedResult) {
		this.input = input;
	...
	public static Collection<String[]> testData() {
		return XMLUtils.getTestData("resources/atu321.repository.imported.tests/COU300TC2_GETCOUNTRYNAME");
	}
